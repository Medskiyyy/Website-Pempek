...
import { WhatsAppIcon, InstagramIcon, ClockIcon, MapsIcon } from "../components/Icons";
      ...
      <div className="contact-grid grid-2">
          ...
          <div className="glass-card contact-card-item" style={{ padding: "24px", marginBottom: "20px" }}>
            <div style={{ display: "flex", gap: "16px", alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <a
                  href={`https://wa.me/${settings.whatsappNumber}?text=Halo%20Pempek%20Cek%20Lis%2C%20saya%20ingin%20tanya%20mengenai%20pempek.`}
                  target="_blank"
          ...
          <div className="glass-card contact-card-item" style={{ padding: "24px", marginBottom: "20px" }}>
            <div style={{ display: "flex", gap: "16px", alignItems: "flex-start" }}>
              ...
              <div>
                ...
                >
                  Kunjungi @{settings.instagramUsername}
                </a>
              </div>
            </div>
          </div>
            ...
            <div style={{ display: "flex", gap: "16px", alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <p style={{ color: "var(--text-secondary)", fontSize: "0.95rem" }}>
                  <strong>Operasional:</strong> {settings.workingHours}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="contact-map-panel glass-card" style={{ padding: "16px", display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ marginTop: "16px", textAlign: "center" }}>
            <button
              onClick={() => window.open(getMapsSearchUrl(), "_blank")}
              className="btn btn-secondary btn-sm"
              style={{ width: "100%" }}
            >
